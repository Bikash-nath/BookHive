		...
		<main className='grid min-h-full place-items-center page-gradient px-6 py-24 sm:py-32 lg:px-8'>
			<div className='text-center'>
				...
				<div className='mt-10 flex items-center justify-center gap-x-6'>
					{/* {pathname !== '/' ? ( */}
					<button className='rounded-md bg-[#8C6AFF] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-purple-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#8C6AFF]'>
						Go back home
					</button>
					{/* ) : (< /> )} */}
				</div>
