			...
			<div className='container m-0 p-0'>
				<BgCover>
					...
					<div className='flex flex-col space-y-4 justify-between items-center'>
						<button className='flex items-center justify-center py-2 md:py-3 space-x-2 bg-purple-900 border border-gray-500 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition duration-150'>
							<HeadphoneIcon />
