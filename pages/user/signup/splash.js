			...
			<LoginContainer splashScreen={true}>
				...
				<div className='flex flex-col items-center my-6'>
					<Link href='/user/signup' className='w-full'>
						<button className='w-full rounded-full flex justify-center items-center p-2 lg:p-4 space-x-4 font-bold shadow-sm px-9 hover:bg-opacity-90 border-[0.5px] border-purple-500 border-2 shadow-purple-200 transition hover:-translate-y-0.5 duration-150'>
