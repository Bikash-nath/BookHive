...
function BookCard(props) {
	...
	return (
		<div
			key={key}
			className='flex flex-row items-center justify-center mx-2 sm:mx-3 lg:mx-4 lg:w-44 lg:h-80 lg:py-2 rounded-md group-hover:flex '>
			<Link href={`/books/${slug}`}>
				<div className='relative flex flex-col w-full h-full rounded-md p-2 bg-gray-700 bg-opacity-60 hover:bg-opacity-100 overflow-hidden'>
					...
					<img
						src={image}
						alt={title}
						className='object-contain rounded-md lg:w-40 lg:h-60 lg:py-1 min-w-full transform hover:scale-105 duration-200'
					/>
