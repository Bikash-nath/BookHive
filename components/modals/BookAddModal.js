	...
	return (
		<div
			...
			<div className='absolute top-0 flex items-center justify-center min-h-screen w-full'>
				<div className='flex flex-col justify-center hide-scrollbar gap-4 xl:gap-6 w-full sm:w-1/2 lg:w-5/12 xl:w-2/5 p-4 pb-16 xl:p-6 xl:pb-14 rounded-md bg-[#0C111B]'>
