	...
	return (
		<div
			...
			<Link href={`/author/${slug}`}>
				<div className='flex flex-col w-full h-full rounded-xl p-1 bg-gray-700 bg-opacity-60 hover:bg-opacity-100 hover:scale-105 duration-200 transform overflow-hidden backdrop-blur-sm animate-slideup'>
					<img
						src={image}
						alt={name}
