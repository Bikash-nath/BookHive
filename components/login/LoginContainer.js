...
function LoginContainer(props) {
	return (
		<div className='flex items-start justify-center h-screen bg-black text-white pt-8 p-0 m-0'>
			<div className='relative flex flex-col rounded-2xl md:flex-row md:space-y-0 py-1 m-0 md:h-screen md:flex justify-center items-center'>
				<div className='px-4 md:p-4 w-screen md:w-1/2'>
					...
					<div className='flex flex-col items-center mb-8 relative'>
						<div className='flex md:hidden justify-center items-center -mt-10'>
							...
							<img src='/images/bookhive.webp' alt='Bookhive' className=' w-8/12' />
						</div>
